...
class VendorSentThreadMessage extends Mailable
{
    ...
    {
        return $this
            ->subject($this->thread->opportunity->organisation->name.' sent you a message.')
            ->from('no-reply@firecat.io')
            ->view('email.partner.vendor_sent_thread_message');
    }
}
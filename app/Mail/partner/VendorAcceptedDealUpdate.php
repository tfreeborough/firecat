...
class VendorAcceptedDealUpdate extends Mailable
{
    ...
    {
        return $this
            ->subject($this->deal->opportunity->organisation->name.' has accepted your proposed change.')
            ->from('no-reply@firecat.io')
            ->view('email.partner.proposed_change_accepted');
    }
}